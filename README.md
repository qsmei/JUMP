# JUMP
A Julia Package (binary version) for genomic selection(prediction) with BLUP and Bayesian methods! In the current stage, i just use this software to complete my analysis. More functions are under releasing, speed and memory performance would be the next step target! 
